...
{//IA2-P2”.
    ...
    {//Recibe el tipo de daño, pregunta cuanto es y lo resta de la vida del nexo
    ...
    {    //Recibe el valor de vida actual del NexusStats y lo guarda en la variable de vida local
